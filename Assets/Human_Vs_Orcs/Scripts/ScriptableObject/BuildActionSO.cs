...
{
    [Header("Prefabs")]
    [SerializeField] private Units workerUnitPrefab;
    [SerializeField] private Structure_Unit structurePrefab;
    ...
    [SerializeField]private Vector2Int buildingSize=new Vector2Int();
    [SerializeField] private float constructionTime;
     [SerializeField]private Vector3 highlightTilemapOffset=new Vector3();
